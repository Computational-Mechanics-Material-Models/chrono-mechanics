...
class ChLdpmApi ChLineOfXYZnodes {
  public:
    std::shared_ptr<fea::ChNodeFEAxyz> mnodeB1;
    std::shared_ptr<fea::ChNodeFEAxyz> mnodeB2; 
    //std::shared_ptr<fea::ChNodeFEAxyz> mnodeB3;   

    ChVariables* GetVariables1() { return &mnodeB1->Variables(); }
    ChVariables* GetVariables2() { return &mnodeB2->Variables(); }   
    //virtual ChVariables* GetVariables3() override { return &mnodeB3->Variables(); } 
};
...
/// Utility class for using the ChLinkPoint2Line constraint.
class ChLdpmApi ChLineOfXYZROTnodes {
  public:
    std::shared_ptr<fea::ChNodeFEAxyzrot> mnodeB1;
    std::shared_ptr<fea::ChNodeFEAxyzrot> mnodeB2; 
    //std::shared_ptr<fea::ChNodeFEAxyzrot> mnodeB3;   
...
class ChLdpmApi ChLinkPoint2LineRot : public ChLinkBase {
  ...
  private:
    ...
    */
    ...
    ChConstraintTwoTuples constraint2;
    ChConstraintTwoTuples constraint3;
    ChConstraintTwoTuples constraint4;
    ChConstraintTwoTuples constraint5;
    ChConstraintTwoTuples constraint6;
